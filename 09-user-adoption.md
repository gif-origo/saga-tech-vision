...
**Seamless embedding.** The transition between WPF components and embedded SagaPlus Angular modules should be as invisible as possible. Invest in the shell/host integration layer so that navigation, context passing (e.g., current patient), and visual consistency feel native to users. The WPF shell improvements and standardized module contract ([Section 5.1.4](05-architecture-modernization.md#514-shell-strategy--wpf-modernization--standardized-module-contract)) are key enablers here.
